...
public class Accessory {
    ...
    @ManyToOne //Liên kết tới bảng Car
    @JoinColumns //Khóa chính nhiều cột nên thêm đuôi s
            (value = {
    ...
    @OnDelete(action = OnDeleteAction.CASCADE) //Xóa bảng con accessory nếu xóa bảng cha car
    private Car car;
}
